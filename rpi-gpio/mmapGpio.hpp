...
public:
    ...
    void setPinPUD(unsigned int pinnum, const unsigned int &pud);
	...
	static const unsigned int GPPUDCLK1 = 39;
	...
	// Overall pull up
    static const unsigned int PUD_OFF  = 0;
    static const unsigned int PUD_DOWN = 1;
    static const unsigned int PUD_UP   = 2;
